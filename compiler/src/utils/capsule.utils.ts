...
if (process.env.DEBUG) {debug('capsule');}
...
export async function createCapsule(isolate: (isolateOptions: IsolateOptions) => any, isolateOptions: GenericObject ={}, capsulePath?: string) {
